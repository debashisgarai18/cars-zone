...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'CarZone',
    "address" TEXT NOT NULL DEFAULT '69, PatalLok, Outer Jamnapaar, 380678',
    "phone" TEXT NOT NULL DEFAULT '+91 7689-3452',
    "email" TEXT NOT NULL DEFAULT 'masterjicr7@carzone.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
